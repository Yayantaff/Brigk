...
(cl:in-package swarm_control_package-msg)
...
(cl:defclass <FiducialTransformArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (transforms
    :reader transforms
    :initarg :transforms
    :type (cl:vector swarm_control_package-msg:FiducialTransform)
   :initform (cl:make-array 0 :element-type 'swarm_control_package-msg:FiducialTransform :initial-element (cl:make-instance 'swarm_control_package-msg:FiducialTransform))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <FiducialTransformArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FiducialTransformArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name swarm_control_package-msg:<FiducialTransformArray> is deprecated: use swarm_control_package-msg:FiducialTransformArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FiducialTransformArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_control_package-msg:header-val is deprecated.  Use swarm_control_package-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_seq-val :lambda-list '(m))
(cl:defmethod image_seq-val ((m <FiducialTransformArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_control_package-msg:image_seq-val is deprecated.  Use swarm_control_package-msg:image_seq instead.")
  (image_seq m))

(cl:ensure-generic-function 'transforms-val :lambda-list '(m))
(cl:defmethod transforms-val ((m <FiducialTransformArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader swarm_control_package-msg:transforms-val is deprecated.  Use swarm_control_package-msg:transforms instead.")
  (transforms m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FiducialTransformArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'transforms)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'swarm_control_package-msg:FiducialTransform))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FiducialTransformArray>)))
  ...
  "swarm_control_package/FiducialTransformArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FiducialTransformArray)))
  "Returns string type for a message object of type 'FiducialTransformArray"
  "swarm_control_package/FiducialTransformArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FiducialTransformArray>)))
  ...
  (cl:format cl:nil "# Fiducial transform array message~%#Header header                        # Standard ROS message header~%#fiducial_msgs/FiducialTransform[] transforms  # Array of fiducial transforms~%~%# A set of camera to fiducial transform with supporting data corresponding~%# to an image~%Header header~%int32 image_seq~%FiducialTransform[] transforms ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: swarm_control_package/FiducialTransform~% # A camera to fiducial transform with supporting data~% int32 fiducial_id~% geometry_msgs/Transform transform~% float64 image_error~% float64 object_error~% float64 fiducial_area~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FiducialTransformArray)))
  "Returns full string definition for message of type 'FiducialTransformArray"
  (cl:format cl:nil "# Fiducial transform array message~%#Header header                        # Standard ROS message header~%#fiducial_msgs/FiducialTransform[] transforms  # Array of fiducial transforms~%~%# A set of camera to fiducial transform with supporting data corresponding~%# to an image~%Header header~%int32 image_seq~%FiducialTransform[] transforms ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: swarm_control_package/FiducialTransform~% # A camera to fiducial transform with supporting data~% int32 fiducial_id~% geometry_msgs/Transform transform~% float64 image_error~% float64 object_error~% float64 fiducial_area~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
