...
"""autogenerated by genpy from swarm_control_package/FiducialTransformArray.msg. Do not edit."""
import codecs
import sys
...
import std_msgs.msg
import swarm_control_package.msg

class FiducialTransformArray(genpy.Message):
  _md5sum = "a9391b25df2859cb1ae6fa6ee45ef075"
  _type = "swarm_control_package/FiducialTransformArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Fiducial transform array message
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','swarm_control_package/FiducialTransform[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = swarm_control_package.msg.FiducialTransform()
        start = end
        end += 4
